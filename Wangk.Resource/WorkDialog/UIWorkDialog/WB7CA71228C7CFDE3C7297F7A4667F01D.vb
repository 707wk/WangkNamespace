...
Public Class WB7CA71228C7CFDE3C7297F7A4667F01D
    Implements UIWorkEventArgs

    ''' <summary>
    ''' 前台触发事件
    ''' </summary>
    Private UIWorkAction As Action(Of UIWorkEventArgs)
...
#Region "传递的参数"
    ...
    ''' 传递的参数
    ''' </summary>
    Public Property Args As Object Implements UIWorkEventArgs.Args
        Get
            Return _Args
        End Get
        Set(value As Object)
...
#Region "操作结果"
    ...
    ''' 操作结果
    ''' </summary>
    Public Property Result As Object Implements UIWorkEventArgs.Result
        Get
            Return _Result
        End Get
        Set(value As Object)
...
#End Region
    ...
    Public Overloads Sub Start(UIWorkAction As Action(Of UIWorkEventArgs))
    ...
    Public Sub Write(msg As String) Implements UIWorkEventArgs.Write
